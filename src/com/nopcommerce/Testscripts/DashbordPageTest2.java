...
public class DashbordPageTest2 {
	...
	@Test(groups="sanity",retryAnalyzer=RetryAnalyzer.class,priority=1,enabled=true,description="Here login button functionality with valid data")
	...
	@Test(groups="sanity",retryAnalyzer=RetryAnalyzer.class,dependsOnMethods="verifyLoginBtnFunctionalityByUsingValidData",priority=2,enabled=true,description="Here searchBox functionality with partial data")
	public void VerifysearchBoxWithValidData() throws Exception {
		String data=ReadData.Getdata("dashboardpage", 1, 2);
		DashBoardPage obj=new DashBoardPage(driver);
